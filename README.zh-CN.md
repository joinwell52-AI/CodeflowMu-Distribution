...
> [!NOTE]
> 下一候选 `V2.2.1 Preview 15` 已在本地完成完整构建、隔离安装、8741 项安装文件校验、启动健康检查和交互界面核对。它提供 CodeFlowMu 品牌欢迎页与 Logo、可编辑的安装目录页、写入前目标目录确认，以及按完整发行版本号发现、确认、下载并安装完整升级包。它尚未上传，因此本页仍只把 Preview 11 列为可下载版本；在 Preview 15 正式发布前，不把这些新增能力反向承诺给 Preview 11。
